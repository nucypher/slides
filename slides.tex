...
\begin{document}
   ...
   \begin{frame}
    ...
    \begin{frame}
      \frametitle{Progress Update}
      \begin{itemize}
        \setlength\itemsep{1em}
        \item ~40-node private testnet running now
        \item >100-node feature-complete public testnet coming soon
        \item Q1 2019 estimated mainnet launch
          \begin{itemize}
            \item Pending legal and regulatory clarification
           \end{itemize}
      \end{itemize}
    \end{frame}
