...
\begin{document}
   ...
   \begin{frame}
    ...
    \begin{frame}
        ...
        \begin{figure}
            \centering
            \includegraphics[height=5.5cm]{pdf/data-lake.pdf}
        \end{figure}
    \end{frame}
    ...
    \begin{frame}
        ...
        \begin{figure}
            \centering
            \includegraphics[height=5.5cm]{pdf/iot-updates.pdf}
        \end{figure}
    \end{frame}
    ...
    \begin{frame}
        ...
        \begin{figure}
            \centering
            \includegraphics[height=7cm]{pdf/file-sharing.pdf}
        \end{figure}
    \end{frame}
    ...
    \begin{frame}
        ...
        \begin{figure}
            \centering
            \includegraphics[height=7cm]{pdf/chats.pdf}
        \end{figure}
    \end{frame}
