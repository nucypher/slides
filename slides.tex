...
\title[NuCypher: Unstoppable end-to-end encrypted apps]{\includegraphics[width=5.5cm]{pdf/nucypher_logo.pdf}}
\author[Michael and Justin]{Michael Egorov and Justin Holmes}
\date[7 Sep]{ETHBerlin, 7 Sep 2018}
