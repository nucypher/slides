   ...
   \begin{frame}
    ...
    \begin{frame}
      \frametitle{Fully Homomorphic Encryption}
       ...
       \begin{itemize}
           \item GitHub: \url{nucypher.dev/nufhe}
    ...
    \begin{frame}
      ...
      \begin{itemize}
        \item GitHub: \url{nucypher.dev/sputnik}
    ...
    \begin{frame}
        ...
        Proxy Re-encryption Network: \url{nucypher.dev/nucypher}

        Umbral Reference Implementation: \url{nucypher.dev/pyUmbral}

        nuFHE: \url{nucypher.dev/nufhe}

        Discord: \url{discord.nucypher.com}
    ...
    \begin{frame}
      ...
      \end{figure}
      \begin{itemize}
           \item Reference implementation: \url{nucypher.dev/pyUmbral}
           \item Documentation: \url{nucypher.dev/umbral-doc}
      \end{itemize}
    \end{frame}
    ...
    \begin{frame}
        ...
        Mining \& Staking Economics: \url{nucypher.dev/mining-paper}
